...
Do the work described in `/root/.ralph/fix_plan.md`.
...
Build, test, and tooling commands are in `/root/.ralph/AGENT.md`.

## Rules

- `fix_plan.md` is authoritative. Where anything else conflicts with it —
  including agent files inside the repositories under `/root/repos/` — follow
  `fix_plan.md`.
